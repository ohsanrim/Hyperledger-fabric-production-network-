...
function createOrg2() {
  ...
  infoln "Generating the peer0_org2 msp"
  set -x
  fabric-ca-client enroll -u https://peer0_org2:peer0pw@fabric-ca:8054 -M ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/msp --csr.hosts peer0.org2.wizchain.net --tls.certfiles $HOME/testnet/crypto-config/fabric-ca/fabric-ca-client/tls-root-cert/tls-ca-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/msp/config.yaml ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/msp/config.yaml
  
  infoln "Generating the peer0_org2-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0-org2:peer0PW@fabric-ca:10054 -M ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls --enrollment.profile tls --csr.hosts peer0.org2.wizchain.net --tls.certfiles $HOME/testnet/crypto-config/fabric-ca/fabric-ca-client/tls-root-cert/tls-ca-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/tlscacerts/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/ca.crt
  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/signcerts/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/server.crt
  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/keystore/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/server.key

  mkdir -p ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/msp/tlscacerts
  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/tlscacerts/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/tlsca
  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/tls/tlscacerts/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/tlsca/tlsca.org2.wizchain.netcert.pem

  mkdir -p ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/ca
  cp ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/peers/peer0.org2.wizchain.net/msp/cacerts/* ${PWD}/crypto-config/peerOrganizations/org2.wizchain.net/ca/ca.org2.wizchain.net-cert.pem
